...
int64 static GetBlockValue(int nHeight, int64 nFees)
{
    ...
    nSubsidy >>= (nHeight / 100000); // Testcoin: 840k blocks in ~4 years

    return nSubsidy + nFees;
}

static const int64 nTargetTimespan = 2 * 24 * 60 * 60; // Testcoin: 2 days
static const int64 nTargetSpacing = 2 * 60; // Testcoin: 2 minutes
...
unsigned char pchMessageStart[4] = { 0xf2, 0xca, 0xbf, 0xd2 }; // Testcoin: absolute random.
