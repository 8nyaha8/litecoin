...
* Update manpages, see [gen-manpages.sh](https://github.com/IvanSurfer/testcoin/blob/master/contrib/devtools/README.md#gen-manpagessh).
...
Check out the source code in the following directory hierarchy.
    ...
    git clone https://github.com/IvanSurfer/gitian.sigs.ltc.git
    git clone https://github.com/IvanSurfer/testcoin-detached-sigs.git
    git clone https://github.com/devrandom/gitian-builder.git
    git clone https://github.com/IvanSurfer/testcoin.git
...
- Detached signatures will then be committed to the [testcoin-detached-sigs](https://github.com/IvanSurfer/testcoin-detached-sigs) repository, which can be combined with the unsigned apps to create signed binaries.
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/IvanSurfer/testcoin/releases/new) with a link to the archived release notes.
