...
Then, to tunnel a SSL connection on 25887 to a RPC server bound on localhost on port 19334 do:

    stunnel -d 25887 -r 127.0.0.1:19334 -p stunnel.pem -P ''
...
caching. A sample config for apache2 could look like:
    ...
    <Location /testcoinrpc>
        ProxyPass http://127.0.0.1:5887/
        ProxyPassReverse http://127.0.0.1:5887/
