...
Output from `gbuild` will look something like
    ...
    From https://github.com/IvanSurfer/testcoin
...
[IvanSurfer/gitian.sigs.ltc](https://github.com/IvanSurfer/gitian.sigs.ltc/) repository, or if that's not possible create a pull
